package com.axepta.android.sdk.example.adapters

import android.view.LayoutInflater
import android.view.View
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.axepta.android.sdk.PaymentMethod
import com.axepta.android.sdk.example.R
import com.axepta.android.sdk.example.adapters.PaymentMethodAdapter.ViewHolder
import kotlinx.android.synthetic.main.cell_payment.view.*

class PaymentMethodAdapter(private var onItemClicked: ((paymentMethod: PaymentMethod, payType: String) -> Unit)? = null) : RecyclerView.Adapter<ViewHolder>() {
    ...
    class ViewHolder(private val paymentMethodView: View, private val onItemClicked: ((paymentMethod: PaymentMethod, payType: String) -> Unit)?) : RecyclerView.ViewHolder(paymentMethodView) {
